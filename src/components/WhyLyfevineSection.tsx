        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-600 from-60% to-brand-green rounded-2xl flex items-center justify-center mt-1 group-hover:scale-110 transition-transform duration-300 shadow-glow">
