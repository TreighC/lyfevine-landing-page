...
const Navbar = () => {
  return (
    <nav className="absolute top-0 left-0 right-0 z-50 bg-gradient-to-b from-white/50 via-white/40 to-white/30 border-b border-white/30 shadow-xl shadow-black/15 before:absolute before:inset-0 before:bg-gradient-to-r before:from-white/15 before:via-white/8 before:to-white/15 after:absolute after:inset-0 after:bg-gradient-to-b after:from-transparent after:via-transparent after:to-black/5">
