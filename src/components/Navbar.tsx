...
const Navbar = () => {
  return (
    <nav className="absolute top-0 left-0 right-0 z-50 bg-gradient-to-b from-white/40 via-white/30 to-white/20 border-b border-white/20 shadow-xl shadow-black/10 before:absolute before:inset-0 before:bg-gradient-to-r before:from-white/10 before:via-white/5 before:to-white/10 after:absolute after:inset-0 after:bg-gradient-to-b after:from-transparent after:via-transparent after:to-black/3">
